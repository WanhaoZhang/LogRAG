from prelogad.DeepSVDD.src.base.base_dataset import BaseADDataset
from prelogad.DeepSVDD.src.networks.main import build_network, build_autoencoder
from prelogad.DeepSVDD.src.optim.deepSVDD_trainer import DeepSVDDTrainer
from prelogad.DeepSVDD.src.optim.ae_trainer import AETrainer
import json
import torch
...
class DeepSVDD(object):
    ...
    def test(self, dataset: BaseADDataset, device: str = 'cuda', n_jobs_dataloader: int = 0):
        ...
        abnormal, normal = self.trainer.test(dataset, self.net)
        # Get results
